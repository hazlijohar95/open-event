          ...
          <div className="space-y-16">
            ...
            <section id="getting-started" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-8 h-8 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center">
                  <Rocket size={16} className="text-indigo-600 dark:text-indigo-400" weight="duotone" />
                </div>
                <h2 className="text-lg font-semibold">Getting Started</h2>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { title: 'Sign up for free', desc: 'No credit card required. Unlimited events forever.' },
                  { title: 'Choose your role', desc: 'Organizer, sponsor, or vendor — each has a tailored dashboard.' },
                  { title: 'Create your first event', desc: 'AI assistant helps you set up in minutes.' },
                  { title: 'Invite your team', desc: 'Collaborate with unlimited team members.' },
                ].map((item) => (
                  <div key={item.title} className="p-4 rounded-lg border border-border/40 hover:border-border transition-colors">
            ...
            <section id="for-organizers" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-8 h-8 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                  <Calendar size={16} className="text-blue-600 dark:text-blue-400" weight="duotone" />
                </div>
                <h2 className="text-lg font-semibold">For Organizers</h2>
              </div>
              <div className="space-y-2">
                {[
                  { title: 'Centralized dashboard', desc: 'Manage all events, sponsors, and vendors from one place.' },
                  { title: 'AI-powered matching', desc: 'Get recommendations for sponsors and vendors that fit your audience.' },
                  { title: 'Automated communications', desc: 'Send updates, contracts, and reminders automatically.' },
                  { title: 'Real-time analytics', desc: 'Track RSVPs, engagement, and sponsor ROI as it happens.' },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/30 transition-colors">
            ...
            <section id="for-sponsors" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-8 h-8 rounded-lg bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center">
                  <Handshake size={16} className="text-amber-600 dark:text-amber-400" weight="duotone" />
                </div>
                <h2 className="text-lg font-semibold">For Sponsors</h2>
              </div>
              <div className="space-y-2">
                {[
                  { title: 'Discover events', desc: 'Browse a marketplace of events looking for sponsors.' },
                  { title: 'Audience match scoring', desc: 'See how well an event aligns with your target market.' },
                  { title: 'Track ROI', desc: 'Get detailed analytics on booth visits and lead captures.' },
                  { title: 'Manage packages', desc: 'Compare sponsorship tiers, benefits, and pricing.' },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/30 transition-colors">
            ...
            <section id="for-vendors" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-8 h-8 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center">
                  <Storefront size={16} className="text-emerald-600 dark:text-emerald-400" weight="duotone" />
                </div>
                <h2 className="text-lg font-semibold">For Vendors</h2>
              </div>
              <div className="space-y-2">
                {[
                  { title: 'Inbound opportunities', desc: 'Get discovered by organizers looking for your services.' },
                  { title: 'Build your reputation', desc: 'Collect reviews and ratings from past events.' },
                  { title: 'Transparent pricing', desc: 'Set your rates clearly. No bidding wars.' },
                  { title: 'Secure payments', desc: 'Contracts and payments handled with protection.' },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/30 transition-colors">
            ...
            <section id="ai-features" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-8 h-8 rounded-lg bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center">
                  <Sparkle size={16} className="text-violet-600 dark:text-violet-400" weight="duotone" />
                </div>
                <h2 className="text-lg font-semibold">AI Features</h2>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                {[
                  { title: 'Smart event setup', desc: 'Describe your event and let AI generate timelines and checklists.' },
                  { title: 'Sponsor matching', desc: 'AI analyzes your audience and suggests best-fit sponsors.' },
                  { title: 'Vendor recommendations', desc: 'Suggestions based on budget, event type, and performance.' },
                  { title: 'Automated reports', desc: 'AI generates post-event summaries and ROI insights.' },
                ].map((item) => (
              ...
              <div className="p-3 rounded-lg bg-muted/30 border border-border/40">
                <p className="text-xs text-muted-foreground">
                  <strong className="text-foreground">Note:</strong> AI features use OpenAI and Anthropic. Your data is never used to train models.{' '}
            ...
            <section id="integrations" className="scroll-mt-24">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
                {['Google Calendar', 'Slack', 'Discord', 'Stripe', 'Outlook', 'iCal', 'Webhooks', 'API'].map((name) => (
              ...
              <div className="p-3 rounded-lg bg-amber-50/50 dark:bg-amber-950/20 border border-amber-200/50 dark:border-amber-800/30">
                <p className="text-xs text-muted-foreground">
                  <strong className="text-amber-700 dark:text-amber-400">Coming soon:</strong> Zapier, Make, and n8n integrations.
                </p>
              </div>
            </section>
            ...
            <section id="self-hosting" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-8 h-8 rounded-lg bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center">
                  <CloudArrowUp size={16} className="text-cyan-600 dark:text-cyan-400" weight="duotone" />
                </div>
                <h2 className="text-lg font-semibold">Self-Hosting</h2>
              </div>
              <div className="space-y-2 mb-4">
                {[
                  { title: 'Open source', desc: 'MIT licensed. Fork it, modify it, make it yours.' },
                  { title: 'Docker deployment', desc: 'Spin up your own instance with docker-compose.' },
                  { title: 'Convex backend', desc: 'Real-time sync database out of the box.' },
                  { title: 'Environment variables', desc: 'Configure AI providers and auth via env vars.' },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/30 transition-colors">
            ...
            <section id="contributing" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-8 h-8 rounded-lg bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center">
                  <GitPullRequest size={16} className="text-orange-600 dark:text-orange-400" weight="duotone" />
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  ...
                  <div key={item.title} className="p-3 rounded-lg border border-border/40 hover:border-border transition-colors">
                    <p className="text-sm font-medium text-foreground">{item.title}</p>
                    <p className="text-xs text-muted-foreground">{item.desc}</p>
                  </div>
                ))}
            ...
            <section id="roadmap" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-8 h-8 rounded-lg bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center">
                  <MapTrifold size={16} className="text-rose-600 dark:text-rose-400" weight="duotone" />
                </div>
